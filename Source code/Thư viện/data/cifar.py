...
def get_cifar_10_100_datasets(train_transform, test_transform, train_classes=(0, 1, 8, 9),
    ...
    train_dataset_whole = CustomCIFAR10(root='/content/drive/MyDrive/KLTN_19521818/osr_closed_set_all_you_need-main/dataset/cifar10', transform=train_transform, train=True)
    ...
    test_dataset_known = CustomCIFAR10(root='/content/drive/MyDrive/KLTN_19521818/osr_closed_set_all_you_need-main/dataset/cifar10', transform=test_transform, train=False)
    test_dataset_known = subsample_classes(test_dataset_known, include_classes=train_classes)

    # Get testset for unknown classes
    test_dataset_unknown = CustomCIFAR100(root='/content/drive/MyDrive/KLTN_19521818/osr_closed_set_all_you_need-main/dataset/cifar100', transform=test_transform, train=False)
    ...
    return all_datasets,train_dataset.class_to_idx,test_dataset_unknown.class_to_idx
...
def get_cifar_10_10_datasets(train_transform, test_transform, train_classes=range(4),
    ...
    # Init train dataset and subsample training classes
    train_dataset_whole = CustomCIFAR10(root='/content/drive/MyDrive/KLTN_19521818/osr_closed_set_all_you_need-main/dataset/cifar10', transform=train_transform, train=True)
    train_class=train_dataset_whole.class_to_idx
    train_dataset_whole = subsample_classes(train_dataset_whole, include_classes=train_classes)
