...
import os
import sys
py_file_location = "/content/drive/MyDrive/CS505/osr_closed_set_all_you_need-main"
...
def get_default_hyperparameters(args):
    ...
    hyperparameter_path = os.path.join( '/content/drive/MyDrive/CS505/osr_closed_set_all_you_need-main/utils/paper_hyperparameters.csv')
